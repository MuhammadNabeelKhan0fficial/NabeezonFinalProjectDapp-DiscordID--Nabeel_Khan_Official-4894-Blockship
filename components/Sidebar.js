...
import logo from '../assets/nabeezon_logo.png'
import logoFull from '../assets/nabeezon_logo_full.png'
import Image from 'next/image'
import { FaBox } from 'react-icons/fa'
import { BsFillBookmarkFill } from 'react-icons/bs'
import { BsFillPersonFill } from 'react-icons/bs'
import { NabeezonContext } from '../context/NabeezonContext'
...
const Sidebar = () => {
  const styles = {
    ...
    nabeezonLogo: `mr-4 flex object-cover`,
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.companyName}>
        <Image src={logoFull} alt='nabeezon' height={100} width={100} />
      </div>
    </div>
  )
}
